...
<div class="signup">
 ...
 <form action="Register" method="post">
   ...
   <input type="text" required name="customerName" placeholder="CustomerName" /> 
   <input type="text" required name="fatherName" placeholder="fatherName" />
   <input type="Email" required name="customerEmail" placeholder="customerEmail" />
   <input type="password" required name="password" placeholder="password"/>
   <input type="text" required name="address" placeholder="address" />
   <input type="number" required name="phoneNumber" placeholder="phoneNumber" />
   <input type="submit" required value="Sign UP" id="submit"  />
 </form>
 </div>
 </div>
